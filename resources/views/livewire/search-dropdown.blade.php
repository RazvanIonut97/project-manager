    ...
    <div x-data="{isOpen:true}" @click.away="isOpen=false">
        ...
        <div x-show="isOpen" class="absolute bg-gray-50 rounded w-48 mt-3 shadow-lg">
            ...
            <ul>
                ...
                <li class="border-b border-gray-200 hover:bg-red-100 flex justify-between items-center">
                    <p class="px-3 py-2 ">{{$result->surname}}</p>
                ...
                @else
                <li wire:click="asignUser({{$result->id}})"
